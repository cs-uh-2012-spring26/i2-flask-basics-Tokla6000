...
class Student(Resource):
    ...
    @api.doc(
        "Delete a specific student given email",
        params={"email": "Student email to use for deletion"},
    )
    @api.response(
        HTTPStatus.OK,
        "Success",
    ...
    @api.response(
        HTTPStatus.NOT_FOUND,
        "Student Not Found",
        api.model("Delete Student: Not Found", {MSG: fields.String("Student not found")}),
    )
